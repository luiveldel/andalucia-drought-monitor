...
def _empty_payload() -> dict[str, Any]:
    return {
        ...
        "irrigation_autonomy": {"available": False, "as_of_reservoir": None, "as_of_siar": None, "kc": None, "irrigated_ha_source": "", "storage_scope": "", "note": "", "method_es": "", "regional": None, "by_province": [], "alerts": [], "projection": {"available": False}, "ria_siar_compare": {"available": False}, "cut_risk": {"available": False}, "scenarios": {"available": False}},
