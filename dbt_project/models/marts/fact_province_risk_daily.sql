...
-- Riesgo provincial diario (heurística operativa). Grain: observation_date + province_name.

with base as (
  select
    observation_date,
    province_name,
    watershed_demarcation as primary_watershed_demarcation,
    avg_fill_pct,
    total_stored_hm3,
