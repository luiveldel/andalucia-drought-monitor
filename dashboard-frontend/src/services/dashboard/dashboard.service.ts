...
function mapApiToSnapshot(api: ApiPayload, range: DashboardTimeRange): DashboardSnapshot {
  ...
  return {
    ...
    irrigationAutonomy: api.irrigation_autonomy ?? {
      ...
      chg_layers: { available: false, provider: "CHG IDE-CHG GeoServer", attribution: "", attribution_html: "", base_wfs: "https://idechg.chguadalquivir.es/geoserver/ggiscloud_root/ows", base_wms: "https://idechg.chguadalquivir.es/geoserver/ggiscloud_root/wms", crs_request: "EPSG:4326", crs_native_typical: "EPSG:25830", wfs_version: "1.1.0", cache_ttl_s: 86400, simplify_tol_deg: 0.005, as_of: null, fetched_at: null, lazy: true, note_es: "", caveats_es: [], layers: [], pes_kpi: { available: false, as_of: null, fetched_at: null, note_es: "", caveat_es: "", escasez: { available: false, counts_by_escenario: {} }, sequia: { available: false, counts_by_estado: {} } } },
      open_layers: { available: false, provider: "REDIAM / ICRA", attribution: "", attribution_html: "", lazy: true, as_of: null, fetched_at: null, note_es: "", caveats_es: [], rejected_sources_es: [], layers: [], groups: { rediam: [], icra: [], chg_extras: [] } },
    },
